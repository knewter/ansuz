...
module ApplicationHelper
  ...
  def ajax_spinner_for(id, spinner="spinner.gif")
    "<img src='/plugin_assets/ansuz_savage_beast/images/#{spinner}' style='display:none; vertical-align:middle;' id='#{id.to_s}_spinner'> "
  end
  ...
  def feed_icon_tag(title, url)
    ...
    link_to image_tag('feed-icon.png', :size => '14x14', :style => 'margin-right:5px', :alt => "Subscribe to #{title}", :plugin => "ansuz_savage_beast"), url
  end
