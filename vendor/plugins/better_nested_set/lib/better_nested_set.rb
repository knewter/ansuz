    ...
    module NestedSet #:nodoc:
      ...
      module ClassMethods
        ...
        def acts_as_nested_set(options = {})          
          ...
          has_many :children, :class_name => name, :foreign_key => acts_as_nested_set_options[:parent_column], :order => acts_as_nested_set_options[:left_column], :dependent => :destroy
...
#            }
      ...
      module InstanceMethods
        ...
        def before_before_destroy # already protected by a transaction
