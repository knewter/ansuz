...
(function (jQuery) {
    ...
    jQuery.fn.popeye = function (options) {
        ...
        return this.each(function(){
            ...
            function display(i, transition) {
                ...
                if(transition) {
                    ppyStage.fadeTo(100,0,function(){
                        jQuery(this).css(stageIm).fadeTo(100,1);
                    });
                }
                else {
            ...
            // crate html nodes
            var ppyStageWrap = jQuery('<div class="popeye-stagewrap" />');
            var ppyStage     = jQuery('<div class="popeye-stage" />');
            var ppyToolsWrap = jQuery('<div class="popeye-tools-wrap" />');
            var ppyTools     = jQuery('<div class="popeye-tools" />');
            var ppyCount     = jQuery('<span class="popeye-count" />');
            var ppyCur       = jQuery('<em class="popeye-cur" />');
            var ppyTotal     = jQuery('<em class="popeye-total" />');
            var ppyPrev      = jQuery('<a href="#" class="popeye-prev">' + opts.plabel + '</a>');
            var ppyNext      = jQuery('<a href="#" class="popeye-next">' + opts.nlabel + '</a>');
            var ppyEnlarge   = jQuery('<a href="#" class="popeye-enlarge">' + opts.blabel + '</a>');
            var ppyCap       = jQuery('<div class="popeye-cap" />');
